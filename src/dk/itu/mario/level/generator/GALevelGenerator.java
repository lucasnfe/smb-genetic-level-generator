...
public class GALevelGenerator implements LevelGenerator {
	...
	public LevelInterface generateLevel(GamePlay playerMetrics) {
		...
		UniformGASuperMario gaMap = new UniformGASuperMario(LEVEL_WIDTH * 2, INDIVIDUAL_SIZE, 0.01f, 0.8f, (int)(0.25 * INDIVIDUAL_SIZE), 2);
		gaMap.StartEvolution(LEVEL_WIDTH * 2);
		
                System.out.println("---------------------------");
                
                GAEnemies gaEnemies = new GAEnemies(LEVEL_WIDTH * 2, INDIVIDUAL_SIZE, 0.01f, 0.8f, (int)(0.25 * INDIVIDUAL_SIZE), 2, gaMap.getBestIndividual(), 0.25f);
